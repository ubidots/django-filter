...
from django_filters.groups import FilterGroup
...
class ModuleImportTests(TestCase):
    ...
    def test_imports(self):
        group_classes = [
            ...
            if isinstance(value, type) and issubclass(value, groups.FilterGroup)
        ]

        # sanity check
        self.assertIn('FilterGroup', group_classes)
...
class FilterGroupFormatLabelsTests(TestCase):
    ...
    def setUp(self):
        ...
        self.group = FilterGroup(['foo', 'bar'])
...
class ConcreteFilterGroupSanityChecks:
    ...
    def test_filter_invalid_data(self):
        ...
        # 'baz' filter not a member of the group
        with self.assertRaisesMessage(AssertionError, msg):
...
class ExclusiveGroupTests(ConcreteFilterGroupSanityChecks, TestCase):
    ...
    def test_validate_multiple_parial(self):
...
class CombinedRequiredGroupTests(ConcreteFilterGroupSanityChecks, TestCase):
    ...
    test_validate_multiple_parial = RequiredGroupTests.test_validate_multiple_parial
